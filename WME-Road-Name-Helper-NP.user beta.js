...
`;
  ...
  const downloadUrl = 'https://greasyfork.org/scripts/538171-wme-road-name-helper-np-beta/code/wme-road-name-helper-np-beta.user.js';
  const forumURL = 'https://greasyfork.org/en/scripts/538171-wme-road-name-helper-np-beta/feedback';
...
// Google Translate SVG
    ...
    async function translateToNepali(text) {
            ...
            if (specialMatched) return specialText;
